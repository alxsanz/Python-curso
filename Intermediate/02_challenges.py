...
los números del 1 al 100 (ambos incluidos y con un salto de línea 
...
# list100 = [i + 1 for i in range(100)]
...
Hecho esto, imprime los números primos entre el 1 y el 100.
"""
...
"""
Crea un programa que invierta el orden de una cadena de 
texto sin usar funciones propias del lenguaje que lo hagan de forma automática.
- Si le pasamos "Hola mundo" imprime: "odnum aloh".
"""
